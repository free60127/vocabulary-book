...
import { TIMEOUT_FOLLOWUP_MS, TIMEOUT_LOOKUP_MS, TIMEOUT_QUIZ_MS, TIMEOUT_SENTENCE_MS } from '../src/constants.js';
...
const FRONTEND = { lookup: TIMEOUT_LOOKUP_MS, quiz: TIMEOUT_QUIZ_MS, followup: TIMEOUT_FOLLOWUP_MS, sentence: TIMEOUT_SENTENCE_MS };
